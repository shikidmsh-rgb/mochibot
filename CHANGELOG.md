...
- 拒绝执行未完整生成、无法解析或不符合工具参数结构的调用
- 模型服务失败时提供可操作的配置与状态提示
- 深夜对话自然结束时更准确地进入睡前休息

## v1.0.12
- 新增本地历史搜索，可回顾聊天、Diary 和 Memory
- 常用按需工具现在能根据使用习惯自适应加载
- 改进 Bedtime 日记延续、提醒交付与记忆整理可靠性

## v1.0.11
- Agent Free Time 现在能看到最新的待办和习惯状态
- 优化记忆召回流程
- 改进习惯进度记录
- 新增 README 日常使用指南
...
- 修复 Self Reminder 把旧对话当成新消息
- 恢复 Mochi 对 Habit 的自然关注
- 优化记忆召回，减少串台并改善短追问承接
