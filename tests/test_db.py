...
class TestTextSimilarity:
    ...
    def test_near_duplicate_core_memory(self):
        ...
        from mochi.db import text_similarity
        a = "用户是我的主人，我是用户的赛博好友。我们的关系是：我会唠叨用户喝水、关心用户的健康和生活、偶尔毒舌吐槽，但永远站在用户这边。用户有只叫红糖的英短金渐层（5岁，甲亢）和一只叫蛋挞的狗。"
        b = "用户是我的主人，我是用户的赛博好友。我们的关系是：我会唠叨用户喝水、关心用户的健康和生活、偶尔毒舌吐槽，但永远站在用户这边。用户是女生，有只叫红糖的英短金渐层（5岁，甲亢）和一只叫蛋挞的狗。"
