...
THINK_MAX_TOKENS = _env_int("THINK_MAX_TOKENS", 800)
THINK_HISTORY_TURNS = _env_int("THINK_HISTORY_TURNS", 10)
LLM_HEARTBEAT_TIMEOUT_SECONDS = _env_int("LLM_HEARTBEAT_TIMEOUT_SECONDS", 120)
PROACTIVE_CHAT_MAX_TOKENS = _env_int("PROACTIVE_CHAT_MAX_TOKENS", 512)       # DEPRECATED: V2 uses THINK_MAX_TOKENS
PROACTIVE_CHAT_HISTORY_TURNS = _env_int("PROACTIVE_CHAT_HISTORY_TURNS", 10)  # DEPRECATED: V2 uses THINK_HISTORY_TURNS
...
BEDTIME_TIDY_MAX_TOKENS = _env_int("BEDTIME_TIDY_MAX_TOKENS", 4096)
