...
| items | array (items: object {name:string, calories:integer, protein_g:number, carbs_g:number, fat_g:number}) | yes | 已吃食物及逐项营养估算；非空数组，每项五个字段齐全，name 非空，营养数值非负且有限；总热量和宏量营养素由代码相加 |
