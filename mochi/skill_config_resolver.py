        ...
        if env_val is not None:
            try:
                ...
                log.warning(
                    ...
                    skill_name, key, "[REDACTED]" if field.secret else env_val, type_name,
                )
