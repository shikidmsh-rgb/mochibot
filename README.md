...
- **联网搜索**——问当前事件、新闻、价格，配置百度千帆 API Key 后优先使用百度；无需 Key 也可使用 Bing，百度不可用时自动切换并注明
...
| **web_search** | 联网搜索——百度千帆优先，Bing 免密钥备用；可在技能配置中设置 `BAIDU_API_KEY` |
